...
fn test_hash() {
    ...
    let returned_bytes: &[u8] = &hex!("0e28130fa5ca11edd3293ca26fdb8ae1810611f78715082ed3841e7486f16677b28e33ffe0b93d98ba57ba358c1343ab2a26b4eb7940f5bc639384641ee80a25140331076268bd1ce702ad534dda0ed8");
...
fn test_hash_add() {
    ...
    let returned_bytes: &[u8] = &hex!("5825fa1d1dc33c64cdc8690682eff06039e79508c3af48e880f8227d5f9aaa14b3bc76baee477ebbb5c45547134179223257525e8f3afefb78b59da032f1006d74c9831375a677eab3239c94ebe3f7fa");
    let mut drbg = Sha1Drbg::new(entropy, nonce, &[]).unwrap();
...
fn test_hmac() {
    ...
    let returned_bytes: &[u8] = &hex!("b7928f9503a417110788f9d0c2585f8aee6fb73b220a626b3ab9825b7a9facc79723d7e1ba9255e40e65c249b6082a7bc5e3f129d3d8f69b04ed1183419d6c4f2a13b304d2c5743f41c8b0ee73225347");
...
fn test_hmac_add() {
    ...
    let returned_bytes: &[u8] = &hex!("942909a9d380aa5d4e3af69093a8fa513ee545b9bf9e1b81c5f30966db3e5cb52f8b1b6fe440d592e5fe4a972c36aa498035e2442f82910c5cd095c7f4b4c7e7555c4669cca481cdfbfda167b5d6f8d5");
    let mut drbg = HmacSha1Drbg::new(entropy, nonce, &[]).unwrap();
...
fn test_aes_ctr() {
    ...
    let returned_bytes: &[u8] = &hex!("6545c0529d372443b392ceb3ae3a99a30f963eaf313280f1d1a1e87f9db373d361e75d18018266499cccd64d9bbb8de0185f213383080faddec46bae1f784e5a");
...
fn test_aes_ctr_add() {
    ...
    let returned_bytes: &[u8] = &hex!("5b2bf7a5c60d8ab6591110cbd61cd387b02de19784f496d1a109123d8b3562a5de2dd6d5d1aef957a6c4f371cecd93c15799d82e34d6a0dba7e915a27d8e65f3");
    let mut drbg = AesCtr128Drbg::new(entropy, &[]).unwrap();
...
fn test_aes_ctr_df() {
    ...
    let returned_bytes: &[u8] = &hex!("a5514ed7095f64f3d0d3a5760394ab42062f373a25072a6ea6bcfd8489e94af6cf18659fea22ed1ca0a9e33f718b115ee536b12809c31b72b08ddd8be1910fa3");
...
fn test_aes_ctr_df_ps() {
    ...
    let returned_bytes: &[u8] = &hex!("35b00df6269b6641fd4ccb354d56d851de7a77527e034d60c9e1a9e1525a30ed361fded89d3dccb978d4e7a9e100ebf63062735b52831c6f0a1d3e1bdc5ebc72");
